...
class PositionService {
  constructor(db, portfolioService, categoryService) {
    this.positionExists = (value, userId, { req }) =>
      __awaiter(this, void 0, void 0, function* () {
        if (
          yield this.db.getPositionById(
            userId,
    ...
    this.createPosition = (req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
    ...
    this.getPositionById = (req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const errors = validationResult(req); // Finds the validation errors in this request and wraps them in an object with handy functions
          if (!errors.isEmpty()) {
          ...
          const result = yield this.db.getPositionById(
            userId,
            portfolioId,
            positionId
          );
          ...
          result[api_definition_1.PayloadKey.VALUES] = yield this.db.getValues(
            userId,
            portfolioId,
            result["id"]
          );
