...
const portfolioService = new portfolio_service_1.PortfolioService(
  new mongodb_database_1.MongoDatabase(process.env.MONGO_URL)
);
...
const valueService = new value_service_1.ValueService(
  new mongodb_database_1.MongoDatabase(process.env.MONGO_URL),
  portfolioService,
  positionService
);
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
  (req, res, nex) => {
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}/:id`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
  (req, res, nex) => {
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}/:portfolioId/${api_definition_1.Url.POSITIONS}`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}/:portfolioId/${api_definition_1.Url.POSITIONS}/:id`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
  positionService.validate("getPosition"),
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}/:portfolioId/${api_definition_1.Url.POSITIONS}/:positionId/${api_definition_1.Url.VALUES}`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
 ...
 */
router.get(
  `/${api_definition_1.Url.PORTFOLIOS}/:portfolioId/${api_definition_1.Url.CATEGORIES}`,
  jwt_validator_1.checkJwt,
  jwt_validator_1.checkJwtScopes,
  jwt_validator_1.setUser,
